...
var rain_count: int = 0   # contador de lluvias activas
...
#region Zoom dinámico según velocidad
...
#region Shake si hay choque o velocidad alta
	var speed_change = abs(speed - last_speed)
